...
* **Date:** 2026-04-08
* **Milestone:** Uploaded test.txt to the week-10-12-ai directory.
...
* **Milestone:** Uploaded `Germany-Power-Bi-Dataset.csv` and `Power BI.pdf` to the `week-05-06-bigquery/PowerBI` directory.
